...
describe('templateRender', () => {
  ...
  it('should leave dot notation placeholder as-is when nested key is not found', () => {
    expect(templateRender('hello {{person.age}}', { person: { name: 'alice' } })).toBe('hello {{person.age}}')
  })
})